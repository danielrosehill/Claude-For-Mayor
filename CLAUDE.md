...
When an area advances a stage, update all four. The landing page's `planks` array is currently
empty with a rendered empty state; adding the first area means populating it and the empty branch
