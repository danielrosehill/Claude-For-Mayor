// Claude-For-Mayor — municipal policy paper house template
...
//     title: [Fixing Refuse Collection],
//     subtitle: [A bylaw and contract programme for the city],
//     paper-no: "MP-001",
...
#let policy-paper(
  ...
  paper-no: "MP-000",
  date: none,
  series: [Claude-For-Mayor · Municipal Policy Papers],
  abstract: none,
  key-findings: (),
  body,
) = {
  ...
  set document(title: title, author: "Claude-For-Mayor")
